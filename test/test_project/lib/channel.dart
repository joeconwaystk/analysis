...
class FoobarChannel extends ApplicationChannel {
  ...
  Future prepare() async {
    ...
    final config = FoobarConfiguration(options.configurationFilePath);
...
class FoobarConfiguration extends Configuration {
  FoobarConfiguration(String fileName) : super.fromFile(File(fileName));
